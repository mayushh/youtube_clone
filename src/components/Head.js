...
import { fun, searchSuggestionApi } from '../Constants/Constant'
...
const Head = () => {
    ...
    const s = useSelector(store => store.app.linkValue);
    ...
    return (
        <div className='  grid grid-flow-col  p-3  z-50 bg-white '>
            ...
            <div className='m-auto p-auto col-span-7  ml-[50px]'>
                <input onChange={(e)=>handleOnChange(e)} value={searchText} className=' search-box p-2 pl-5 shadow-sm shadow-gray-600 outline-none rounded-l-full border  border-gray-200   ' type="text" placeholder='Search' />
